...
Performances of SVM, kNN and CNN(Alexnet) were compared and the best results came from Alexnet with 95.6% accuracy. While using Alexnet framework, we appied data agumentation as well to get better results.
